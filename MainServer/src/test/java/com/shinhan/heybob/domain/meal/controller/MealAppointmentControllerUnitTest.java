...
class MealAppointmentControllerUnitTest {
    ...
    @InjectMocks
    private MealAppointmentController mealAppointmentController;
    ...
    @BeforeEach
    void setUp() {
        mockMvc = MockMvcBuilders.standaloneSetup(mealAppointmentController).build();
